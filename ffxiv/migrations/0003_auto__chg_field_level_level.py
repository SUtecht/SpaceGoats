...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Level.level'
        db.alter_column(u'ffxiv_level', 'level', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Level.level'
        db.alter_column(u'ffxiv_level', 'level', self.gf('django.db.models.fields.IntegerField')())
