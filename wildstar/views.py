...
def index(request):
    ...
    return render_to_response('wildstar/home.html',
            {'articles':articles, 'screenshots':screenshots},
            context_instance=RequestContext(request))

def archive(request):
    articles = Article.objects.all().order_by('-id')
    return render_to_response('wildstar/archive.html',
            {'articles':articles},
            context_instance=RequestContext(request))

def gallery(request):
    screenshots_all = Screenshot.objects.all().order_by('-id')
    return render_to_response('wildstar/gallery.html',
...
def new_article_page(request):
    ...
    return render_to_response('wildstar/new_article.html', {'article_form':article_form},
                                                context_instance=RequestContext(request))
...
def new_screenshot_page(request):
    ...
    return render_to_response('wildstar/new_screenshot.html', {'screenshot_form':screenshot_form},
                                                context_instance=RequestContext(request))
...
def login_view(request):
    ...
    return render_to_response('wildstar/login.html',
