...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event_Attendee'
        db.create_table('demo_event_attendee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demo.Event'])),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demo.Character'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demo.Role'])),
        ))
        db.send_create_signal('demo', ['Event_Attendee'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Event_Attendee'
        db.delete_table('demo_event_attendee')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 1, 15, 52, 37, 387000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 1, 15, 52, 37, 387000)'}),
        ...
        'demo.event_attendee': {
            'Meta': {'object_name': 'Event_Attendee'},
