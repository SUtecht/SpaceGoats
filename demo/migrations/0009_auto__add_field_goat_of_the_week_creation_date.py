...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Goat_of_the_Week.creation_date'
        db.add_column('demo_goat_of_the_week', 'creation_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 12, 21)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Goat_of_the_Week.creation_date'
        db.delete_column('demo_goat_of_the_week', 'creation_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 21, 11, 16, 56, 449000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 21, 11, 16, 56, 449000)'}),
        ...
        'demo.event_attendee': {
            ...
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['demo.Character']"}),
