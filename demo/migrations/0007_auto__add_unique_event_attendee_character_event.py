...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Event_Attendee', fields ['character', 'event']
        db.create_unique('demo_event_attendee', ['character_id', 'event_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Event_Attendee', fields ['character', 'event']
        db.delete_unique('demo_event_attendee', ['character_id', 'event_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 10, 36, 32, 69000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 10, 36, 32, 69000)'}),
