...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.creation_date'
        db.add_column('demo_article', 'creation_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 12, 21)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.creation_date'
        db.delete_column('demo_article', 'creation_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 21, 11, 11, 38, 866000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 21, 11, 11, 38, 866000)'}),
